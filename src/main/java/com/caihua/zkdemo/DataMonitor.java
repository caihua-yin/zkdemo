...
public class DataMonitor implements Watcher, StatCallback {
    ...
    public void processResult(int rc, String path, Object ctx, Stat stat) {
        ...
        // Handle the case the znode existence changes
    ...
    public void process(WatchedEvent event) {
        ...
        if (event.getType() == Event.EventType.None) {
            ...
            case SyncConnected:
                ...
                // here - watches are automatically re-regiestered with server
                // and any watches triggered while the client was disconnected
                // will be delivered (in order of course)
                break;
            case Expired:
                // It's all over
                dead = true;
    ...
    public interface DataMonitorListener {
        /**
         * The existence status of the znode has changed
         */
